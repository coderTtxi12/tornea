...
import { recordMatchCard } from "@/logic/match-operations/record-match-card";
import { cardSchema } from "@/schemas/match-operations/schemas";
...
export async function POST(
  ...
  try {
    ...
    const result = await recordMatchCard({
    ...
    if (!result.ok) {
      ...
      return opsBadRequest("No se pudo registrar la tarjeta.");
    }
